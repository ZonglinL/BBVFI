...
from VFI.archs.VFIformer_arch import VFIformer,FlowRefineNet_Multis_our
...
class FlowDecoderWithResidual(nn.Module):
    ...
    def forward(self, z, cond_dict):
        ...
        #flow, c0, c1 = self.refinenet(frame_prev, frame_next, flow) ## flow and warped features of refined flows, 1, 1/2,1/4,1/8
        flow, c0, c1 = self.refinenet(phi_list[:-2], flow) ## flow and warped features of refined flows, 1, 1/2,1/4,1/8
        ## flow : B 4 H W
